...
try {
    ...
    if ($status === 'APPROVED') {
        ...
        if ($pedido) {
            ...
            // Extrai telefone - prioriza do webhook, senão usa do banco
            $customerPhone = $customerData['phone'] ?? $pedido['telefone'] ?? null;
            ...
            $otimizeyData = [
                ...
                'status' => 'paid',
                'name' => $customerData['name'] ?? $pedido['nome'], // Nome do cliente no nível raiz
