...
try {
    ...
    $apiUrl = 'https://www.pagamentos-seguros.app/api-pix/9qjBrXWEgy69BeAPD1Ta7d8K0zvgs1Vs9znUP0kcPomaFWUgvUOOa5zGCLmTsYK1SXa3rTsjo_KY8kUMRg_8QA';
    $chaveEncriptada = '';
    ...
    if ($httpCode !== 200 && $httpCode !== 201) {
        // Decodifica resposta de erro para mais detalhes
